    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                ...
                                                <div class="staff-id">ID de Empleado : {{ $users->user_id }}</div>
                                                <div class="small doj text-muted">Fecha de Ingreso : {{ $users->join_date }}</div>
                                                <div class="staff-msg"><a class="btn btn-custom" href="chat.html">Enviar Mensaje</a></div>
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                ...
                <div class="row user-tabs">
                    <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                        <ul class="nav nav-tabs nav-tabs-bottom">
                            ...
                            <li class="nav-item"><a href="#bank_statutory" data-toggle="tab" class="nav-link">Banco y Estatutario <small class="text-danger">(Solo Admin)</small></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="tab-content">
                ...
                <div id="emp_profile" class="pro-overview tab-pane fade show active">
                        ...
                        <div class="col-md-6 d-flex">
                            <div class="card profile-box flex-fill">
                                <div class="card-body">
                                    ...
                                    <ul class="personal-info">
                                        <li>
                                            <div class="title">No. de Pasaporte</div>
                                        ...
                                        <li>
                                            <div class="title">Fecha de Vencimiento del Pasaporte</div>
                                        ...
                                        <li>
                                            <div class="title">Empleo del cónyuge</div>
                                        ...
                                        <li>
                                            <div class="title">No. de hijos</div>
                    ...
                    <div class="row">
                        <div class="col-md-6 d-flex">
                            <div class="card profile-box flex-fill">
                                <div class="card-body">
                                    <h3 class="card-title">Información Bancaria
                                    ...
                                    <ul class="personal-info">
                                        <li>
                                            <div class="title">Nombre del Banco</div>
                                            <div class="text">ICICI Bank</div>
                                        </li>
                                        <li>
                                            <div class="title">No. de Cuenta Bancaria</div>
                                            <div class="text">159843014641</div>
                                        </li>
                                        <li>
                                            <div class="title">Código IFSC</div>
                                            <div class="text">ICI24504</div>
                                        </li>
                                        <li>
                                            <div class="title">No. de PAN</div>
                        ...
                        <div class="col-md-6 d-flex">
                            <div class="card profile-box flex-fill">
                                <div class="card-body">
                                    <h3 class="card-title">Información Familiar <a href="#" class="edit-icon" data-toggle="modal" data-target="#family_info_modal"><i class="fa fa-pencil"></i></a></h3>
                    ...
                    <div class="row">
                        <div class="col-md-6 d-flex">
                            <div class="card profile-box flex-fill">
                                <div class="card-body">
                                    <h3 class="card-title">Información Educativa <a href="#" class="edit-icon" data-toggle="modal" data-target="#education_info"><i class="fa fa-pencil"></i></a></h3>
                                ...
                                <div class="card-body">
                                    <div class="dropdown profile-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a data-target="#delete_project" data-toggle="modal" href="#" class="dropdown-item"><i class="fa fa-trash-o m-r-5"></i> Eliminar</a>
                                        </div>
                                    </div>
                ...
                <div class="tab-pane fade" id="bank_statutory">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title">Información Salarial Básica</h3>
                            <form>
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label">Base Salarial <span class="text-danger">*</span></label>
                                            <select class="select">
                                                <option>Seleccionar tipo de base salarial</option>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label">Monto del Salario <small class="text-muted">por mes</small></label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">$</span>
                                                </div>
                                                <input type="text" class="form-control" placeholder="Escriba el monto de su salario" value="0.00">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                ...
                                <hr>
                                <h3 class="card-title">Información de PF</h3>
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label">Contribución de PF</label>
                                            <select class="select">
                                                <option>Seleccionar contribución de PF</option>
                                                <option>Sí</option>
                                                <option>No</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label">No. de PF <span class="text-danger">*</span></label>
                                            <select class="select">
                                                <option>Seleccionar contribución de PF</option>
                                                <option>Sí</option>
                                                <option>No</option>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label">Tasa de PF del Empleado</label>
                                            <select class="select">
                                                <option>Seleccionar contribución de PF</option>
                                                <option>Sí</option>
                                                <option>No</option>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label">Tasa Adicional <span class="text-danger">*</span></label>
                                            <select class="select">
                                                <option>Seleccionar tasa adicional</option>
                                                <option>0%</option>
                                                <option>1%</option>
                                                <option>2%</option>
                                                <option>3%</option>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label">Tasa Total</label>
                                ...
                                <hr>
                                <h3 class="card-title">Información de ESI</h3>
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label">Contribución de ESI</label>
                                            <select class="select">
                                                <option>Seleccionar contribución de ESI</option>
                                                <option>Sí</option>
                                                <option>No</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label">No. de ESI <span class="text-danger">*</span></label>
                                            <select class="select">
                                                <option>Seleccionar contribución de ESI</option>
                                                <option>Sí</option>
                                                <option>No</option>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label">Tasa de ESI del Empleado</label>
                                            <select class="select">
                                                <option>Seleccionar contribución de ESI</option>
                                                <option>Sí</option>
                                                <option>No</option>
                    ...
                    <div class="modal-body">
                        <form action="{{ route('profile/information/save') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Reporta a <span class="text-danger">*</span></label>
                    ...
                    <div class="modal-body">
                        <form action="{{ route('user/information/save') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Empleo del cónyuge</label>
        ...
        <div id="bank_information_modal" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Información Bancaria</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="form-scroll">
                                <div class="card">
                                    <div class="card-body">
                                        <h3 class="card-title">Miembro de la Familia <a href="javascript:void(0);" class="delete-icon"><i class="fa fa-trash-o"></i></a></h3>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Relación <span class="text-danger">*</span></label>
                                                    <input class="form-control" type="text">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h3 class="card-title">Información Educativa <a href="javascript:void(0);" class="delete-icon"><i class="fa fa-trash-o"></i></a></h3>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Nombre <span class="text-danger">*</span></label>
                                        ...
                                        <div class="add-more">
                                            <a href="javascript:void(0);"><i class="fa fa-plus-circle"></i> Añadir Más</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="validation" action="{{ route('user/profile/emergency/contact/save') }}" method="POST">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="card-title">Contacto Secundario</h3>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Nombre <span class="text-danger">*</span></label>
        ...
        <div id="education_info" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Información Educativa</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group form-focus focused">
                                                    ...
                                                    <label class="focus-label">Fecha de Finalización</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group form-focus focused">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group form-focus focused">
                                                    ...
                                                    <label class="focus-label">Calificación</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="form-scroll">
                                <div class="card">
                                    <div class="card-body">
                                        <h3 class="card-title">Información de Experiencia <a href="javascript:void(0);" class="delete-icon"><i class="fa fa-trash-o"></i></a></h3>
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group form-focus">
                                                    ...
                                                    <label class="focus-label">Puesto de Trabajo</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group form-focus">
                                                    ...
                                                    <label class="focus-label">Período Desde</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group form-focus">
                                                    ...
                                                    <label class="focus-label">Período Hasta</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
